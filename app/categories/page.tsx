          ...
          <div className="p-6 md:p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="border border-gray-200 rounded-lg overflow-hidden shadow-sm">
                ...
                <div className="p-4">
                  <div className="w-full h-auto rounded border border-gray-200 relative">
                    <Image 
              ...
              <div className="border border-gray-200 rounded-lg overflow-hidden shadow-sm">
                ...
                <div className="p-4">
                  <div className="w-full max-w-[250px] mx-auto h-auto rounded border border-gray-200 relative">
                    <Image 
